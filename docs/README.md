...
| 獨立預期身份、原始產物與 claims 核對 | [study 輸入驗證契約](contracts/fault-study-expectations.md)（完整正式驗收仍待） |
| 可選的描述性標定分布交換 | [calibration distribution 契約](contracts/calibration-distribution.md)（正式匯出與互通仍待） |
